...
class ContCartPole(gym.Env):
    ...
    def __init__(self, horizon=200, gamma=1.0, render_mode=None):
        # todo do better
    ...
    def reset(self, *, seed=None, options=None, initial=None):
        ...
        if initial is None:
            ...
            self.state = np.asarray(initial, dtype=np.float64)
        self.steps_beyond_done = None
