...
parser.add_argument('--env', help='Gym environment id', type=str, default='LQGX-v0')
...
parser.add_argument('--min_batchsize', help='(Minimum) batch size', type=int, default=10)
...
lip_const = gauss_lip_const(args.max_feat, args.max_rew, args.disc, args.std_init)
