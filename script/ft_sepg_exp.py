...
parser.add_argument('--rmax', help='Discount factor', type=float, default=1.)
parser.add_argument('--phimax', help='Discount factor', type=float, default=1.)
parser.add_argument('--delta', help='Safety is guaranteed w.p. 1-delta', type=float, default=0.2)
parser.add_argument('--safety', help='Experiment name', type=str, default='budget')
parser.add_argument('--confidence', help='Confidence schedule', type=str, default='fixed')
...
if args.confidence == 'eternal':
    cf = InfiniteHorizonConfidence(args.delta)
else:
    cf = None
