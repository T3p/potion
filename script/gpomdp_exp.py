...
if args.trial:
    logger = Logger(directory='../temp', name = envname + '_' + 'gpomdp' + args.stepper + '_' + str(args.seed))
else:
    logger = Logger(directory='../logs', name = envname + '_' + 'gpomdp' + args.stepper + '_' + str(args.seed))
