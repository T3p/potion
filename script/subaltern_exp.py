...
from potion.algorithms.metaexplore import subaltern
...
parser.add_argument('--name', help='Experiment name', type=str, default='test')
...
parser.add_argument('--eta', help='Meta step size', type=float, default=1e-2)
parser.add_argument('--threshold', help='Meta exploration threshold', type=float, default=1e-4)
